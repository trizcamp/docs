---
title: 'Update Fallback'
description: Endpoint to Update Fallback
api: 'PUT https://chat.api.toolzz.com.br/api/v1/bot/{botId}/configuration/fallback/{id}'
---
  ...
  <Expandable title="properties">
    ...
    <ResponseField name="integration" type="object" required>
      <Expandable title="properties">
        ...
        <ResponseField name="form.api_key" type="string" required>
          API key label and configuration for the integration.
        </ResponseField>
        <ResponseField name="status" type="boolean" required>
